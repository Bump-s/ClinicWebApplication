...
namespace ClinicWebApplication
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var doktor1 = new Doktor() { Id = Guid.NewGuid(), FullName = "Andrey Evgenievich", Speciality = Speciality.Test };
            var doktor2 = new Doktor() { Id = Guid.NewGuid(), FullName = "Valeriy Antonov", Speciality = Speciality.Test1 };
            var doktor3 = new Doktor() { Id = Guid.NewGuid(), FullName = "Viktor Pozdnyazkov", Speciality = Speciality.Test1 };
            var doktor4 = new Doktor() { Id = Guid.NewGuid(), FullName = "Mariya Besedina", Speciality = Speciality.Test1 };
            ...
            var doktors = new List<Doktor>() { doktor1, doktor2, doktor3, doktor4 };

            var jsonModule = new JsonModule();

            jsonModule.WriteJson<List<Doktor>>(doktors, path1);
